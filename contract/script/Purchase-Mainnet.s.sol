...
contract PurchaseScript is Script {
    ...
    address MAINNET_PAIR_ROUTER = 0x2B2e8cDA09bBA9660dCA5cB6233787738Ad68329;
    LSSVMRouter router_mainnet = LSSVMRouter(payable(MAINNET_PAIR_ROUTER));
    ...
    function run() public {
        ...
        router_mainnet.robustSwapETHForAnyNFTs{value: inputValue}(
            tmp_,
            payable(dev),
            dev,
